...
cd $DIR
					...
					echo "============================================================"
				    	echo ">>> Running gkkp Matrix Elements Of Electron + Holes at full 2D BZ for quadrupole conditions:"
				    	echo ">>> Note: The Matrix Elements Will Be Printed At all k and q."
...
mkdir -p epw_$prefix/gkkp-full-BZ


PATH1="$DIR/epw_$prefix/w90_calc/nscf_w90"
PATH2="$PATH1/relax_w90"
PATH3="$DIR/epw_$prefix/Quadrupole"
PATH4="$DIR/epw_$prefix/gkkp-full-BZ"
PATH5="$DIR/epw_$prefix/EPW_prelim"
...
cp -r ../../../core_files/EPW_RUN/kq_full_BZ.py ./.

python3 kq_full_BZ.py
