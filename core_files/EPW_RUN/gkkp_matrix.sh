...
cd $DIR
					...
					echo "============================================================"
				    	...
				    	echo ">>> Note: The Matrix Elements Will Be Printed At k = VBM. To Change k, Change Line 47 Of This Script Inside core_files/EPW_RUN."
...
mkdir -p epw_$prefix/gkkp-E-Matrix
