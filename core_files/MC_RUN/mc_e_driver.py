...
bands_to_use = [0]               # None -> use ALL bands; or list like [0,1]
t_index = 5                      # temperature index to use
...
conv_abs_mu_tol_cm2 = 0.1         # absolute μ slope tolerance (cm^2/Vs) over recent window
...
E_ref = np.min(E_states)
boltz = np.exp(-(E_states - E_ref) / (kB_eV * T_K))
